...
namespace neko {
  ...
  public:
    ...
    inline ShaderType type() const { return type_; }
  ...
  protected:
    GLuint id_;
    utf8String name_;
    map<ShaderType, ProgramPtr> stages_;
  public:
    Pipeline( const utf8String& name );
    inline GLuint id() const { return id_; }
    void setProgramStage( ShaderType stage, GLuint id );
    inline GLuint getProgramStage( ShaderType stage )
    {
      assert( stages_[stage] );
      return stages_[stage]->id();
    }
    inline ProgramPtr getProgram( ShaderType stage )
    {
  ...
  protected:
    ...
    void buildSeparableProgram( const utf8String& name, const utf8String& filename, ShaderType type, ShaderPtr& shader,
      ProgramPtr& program, const vector<utf8String>& uniforms );
  public:
