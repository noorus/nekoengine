...
namespace v8pp {
  ...
  namespace detail {
    ...
    public:
      template <typename Traits>
      static object_registry<Traits>& add( v8::Isolate* isolate, type_info const& type, typename object_registry<Traits>::dtor_function&& dtor );
  ...
  public:
    explicit class_( v8::Isolate* isolate, dtor_function destroy = &factory<T, Traits>::destroy )
      : class_info_( detail::classes::add<Traits>( isolate, detail::type_id<T>(), [destroy = std::move( destroy )]( v8::Isolate* isolate, pointer_type const& obj ) {
      ...
      set( char const* name, Method mem_func, v8::PropertyAttribute attr = v8::None )
    {
      ...
      class_info_.class_function_template()->PrototypeTemplate()->Set(
        v8pp::to_v8( isolate(), name ), v8::FunctionTemplate::New( isolate(), &detail::forward_function<Traits, mem_func_type>, detail::set_external_data( isolate(), std::forward<mem_func_type>( mf ) ) ), attr );
      return *this;
    }
      ...
      set( char const* name, Attribute attribute, bool readonly = false )
    {
      ...
      class_info_.class_function_template()->PrototypeTemplate()->SetAccessor( v8pp::to_v8( isolate(), name ), getter, setter, detail::set_external_data( isolate(), std::forward<attribute_type>( attr ) ), v8::DEFAULT, v8::PropertyAttribute( v8::DontDelete | ( setter ? 0 : v8::ReadOnly ) ) );
      return *this;
    }
      ...
      set( char const* name, property_<GetMethod, SetMethod>&& property )
    {
      ...
      class_info_.class_function_template()->PrototypeTemplate()->SetAccessor( v8pp::to_v8( isolate(), name ), getter, setter, detail::set_external_data( isolate(), std::forward<property_type>( prop ) ), v8::DEFAULT, v8::PropertyAttribute( v8::DontDelete | ( setter ? 0 : v8::ReadOnly ) ) );
      return *this;
    }
    ...
    class_& set_const( char const* name, Value const& value )
    {
      ...
      class_info_.class_function_template()->PrototypeTemplate()->Set( v8pp::to_v8( isolate(), name ), to_v8( isolate(), value ), v8::PropertyAttribute( v8::ReadOnly | v8::DontDelete ) );
      return *this;
    }
